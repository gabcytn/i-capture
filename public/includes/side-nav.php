<div class="side-nav">
    ...
    <ul class="side-nav-list">
        ...
        <li class="side-nav-item"><img src="<?= base_url("images/default-profile.jpg") ?>" alt="Profile Picture" id="side-nav-profile"><a href="<?= base_url(session()->get("username")) ?>" class="side-nav-link">Profile</a></li>
    </ul>
</div>